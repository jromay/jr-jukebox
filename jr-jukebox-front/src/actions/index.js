import { DECADES, DECADES_OPTIONS, LANGUAGES, LETTERS, LETTERS_OPTIONS, TAGS, URL_API } from './../constants';
...
export const exchangePositions = payload => ({
  type: EXCHANGE_POSITIONS,
  payload: payload
});
export const removeSong = payload => ({
  type: REMOVE_PERSONAL_LIST_CONTENT,
  payload: payload
});
...
export const addFilteredList = payload => ({
  type: ADD_FILTERED_LIST,
  payload
});

export const setPersonalLists = payload => ({
  type: SET_PERSONAL_LISTS,
  payload
});
export const addPersonalLists = payload => ({
  type: ADD_PERSONAL_LISTS,
  payload
});
export const setPersonalList = payload => ({
  type: SET_PERSONAL_LIST,
  payload
});
export const setPersonalListContent = payload => ({
  type: SET_PERSONAL_LIST_CONTENT,
  payload
});
export const addPersonalListContent = payload => ({
  type: ADD_PERSONAL_LIST_CONTENT,
  payload
});
